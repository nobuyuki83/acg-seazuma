...
// The requirement is:
// m[00]*c0[k0]+m[01]*c0[k1]+m[02]*0+m[03] = a[k]*c1[k0]
// m[10]*c0[k0]+m[11]*c0[k1]+m[12]*0+m[13] = a[k]*c1[k1]
// m[20]*c0[k0]+m[21]*c0[k1]+m[22]*0+m[23] = a[k]*0
// m[30]*c0[k0]+m[31]*c0[k1]+m[32]*0+m[33] = a[k]
//  where k in {0,1,2,3}.
// Assume m[2j]=0, m[i2]=0, and m[33]=1. Eliminating a[k], the requirement is:
// m[00]*c0[k0]+m[01]*c0[k1]+m[03] = (m[30]*c0[k0]+m[31]*c0[k1]+1)*c1[k0]
// m[10]*c0[k0]+m[11]*c0[k1]+m[13] = (m[30]*c0[k0]+m[31]*c0[k1]+1)*c1[k1]
//
// Let x = [ m[00], m[01], m[03], m[10], m[11], m[13], m[m30], m[31] ]
// Then x can be obtained by Ax=b where A,b are defined as below:
 ...
 0, 0, 0, c0[3][0], c0[3][1], 1, -c0[3][0]*c1[3][1], -c0[3][1]*c1[3][1];
  b << c1[0][0],c1[1][0],c1[2][0],c1[3][0], c1[0][1],c1[1][1],c1[2][1],c1[3][1];
